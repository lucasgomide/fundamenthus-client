...
module Fundamenthus
  module Source
    module B3
      class Client
        BASE_URL = 'http://bvmf.bmfbovespa.com.br'.freeze
        COMPANY_URL = "#{BASE_URL}/pt-br/mercados/acoes/empresas/ExecutaAcaoConsultaInfoEmp.asp?CodCVM=".freeze
        EARNINGS_URL = "#{BASE_URL}/cias-Listadas/Empresas-Listadas/ResumoProventosDinheiro.aspx?codigoCvm=".freeze
